...
<div id="comments" class="post">
	...
	<?php if ($comments) { ?>
        ...
        <div class="postcomment">
        		...
        		<p class="comment-author"><?php comment_author_link() ?> says:</p>
				<?php comment_text() ?> 
				<p class="comment-date"><?php comment_date('d M y @ ga') ?></p>
	...
	<?php if ('open' == $post-> comment_status) : ?>
		...
		<?php else : ?>
			...
			<?php } ?>
				...
				<p><textarea class="text_input text_area" name="comment" id="comment" cols="50" rows="10" tabindex="4"></textarea></p>
