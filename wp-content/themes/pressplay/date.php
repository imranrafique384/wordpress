...
<div class="archive-banner">
	...
	<p>
<?php _e('Displaying posts published in', 'pressplay'); echo "</p>"; $currentmonth = single_month_title(' ', false);
	if ($currentmonth != "") { print "<h2>$currentmonth</h2>"; }
	else { print "<h2>"; wp_title('', true, 'right'); print "</h2>"; }
?>
